...
namespace GrpcUnity.Demo {
  public static partial class HelloGrpc
  {
    ...
    public abstract partial class HelloGrpcBase
    {
      ...
      public virtual global::System.Threading.Tasks.Task TestServerSideStreaming(global::GrpcUnity.Demo.StreamData request, grpc::IServerStreamWriter<global::GrpcUnity.Demo.StreamData> responseStream, grpc::ServerCallContext context)
      {
        throw new grpc::RpcException(new grpc::Status(grpc::StatusCode.Unimplemented, ""));
      }

      public virtual global::System.Threading.Tasks.Task<global::GrpcUnity.Demo.StreamData> TestClientSideStreaming(grpc::IAsyncStreamReader<global::GrpcUnity.Demo.StreamData> requestStream, grpc::ServerCallContext context)
      {
        throw new grpc::RpcException(new grpc::Status(grpc::StatusCode.Unimplemented, ""));
      }
    ...
    public partial class HelloGrpcClient : grpc::ClientBase<HelloGrpcClient>
    {
      ...
      public virtual grpc::AsyncServerStreamingCall<global::GrpcUnity.Demo.StreamData> TestServerSideStreaming(global::GrpcUnity.Demo.StreamData request, grpc::Metadata headers = null, global::System.DateTime? deadline = null, global::System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
      {
        return TestServerSideStreaming(request, new grpc::CallOptions(headers, deadline, cancellationToken));
      }
      public virtual grpc::AsyncServerStreamingCall<global::GrpcUnity.Demo.StreamData> TestServerSideStreaming(global::GrpcUnity.Demo.StreamData request, grpc::CallOptions options)
      {
        return CallInvoker.AsyncServerStreamingCall(__Method_TestServerSideStreaming, null, options, request);
      }
      public virtual grpc::AsyncClientStreamingCall<global::GrpcUnity.Demo.StreamData, global::GrpcUnity.Demo.StreamData> TestClientSideStreaming(grpc::Metadata headers = null, global::System.DateTime? deadline = null, global::System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
      {
        return TestClientSideStreaming(new grpc::CallOptions(headers, deadline, cancellationToken));
      }
      public virtual grpc::AsyncClientStreamingCall<global::GrpcUnity.Demo.StreamData, global::GrpcUnity.Demo.StreamData> TestClientSideStreaming(grpc::CallOptions options)
      {
        return CallInvoker.AsyncClientStreamingCall(__Method_TestClientSideStreaming, null, options);
      }
    ...
    public static void BindService(grpc::ServiceBinderBase serviceBinder, HelloGrpcBase serviceImpl)
    {
      ...
      serviceBinder.AddMethod(__Method_TestServerSideStreaming, serviceImpl == null ? null : new grpc::ServerStreamingServerMethod<global::GrpcUnity.Demo.StreamData, global::GrpcUnity.Demo.StreamData>(serviceImpl.TestServerSideStreaming));
      serviceBinder.AddMethod(__Method_TestClientSideStreaming, serviceImpl == null ? null : new grpc::ClientStreamingServerMethod<global::GrpcUnity.Demo.StreamData, global::GrpcUnity.Demo.StreamData>(serviceImpl.TestClientSideStreaming));
